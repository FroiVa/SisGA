"""
Django settings for AsistenciaProject project.
...
SECRET_KEY = 'django-insecure-jhq4h#^8q8pt6-d3sc3)v%tc6zh8icdj^3negdok$zo#m4=w0r'
...
ROOT_URLCONF = 'AsistenciaProject.urls'
...
WSGI_APPLICATION = 'AsistenciaProject.wsgi.application'
...
LDAP_CONFIG = {
    ...
    'BIND_PASSWORD': os.getenv('LDAP_BIND_PASSWORD', 'killdirectory'),
    'USER_BASE': os.getenv('LDAP_USER_BASE', 'ou=Trabajadores,dc=uh,dc=cu'),
